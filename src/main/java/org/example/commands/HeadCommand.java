...
public class HeadCommand implements Command {
    ...
    public String execute(String[] args, User user) {
        Product product = collectionManager.head();
        ...
        sb.append("Первый элемент коллекции (с наименьшим manufactureCost):\n");
        sb.append("----------------------------------------\n");
    ...
    public String getDescription() {
        return "вывести первый элемент коллекции (без удаления)";
    }
}